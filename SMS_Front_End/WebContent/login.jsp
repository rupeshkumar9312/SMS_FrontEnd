...
<%@taglib prefix="ctu" uri="WEB-INF/c.tld" %>
    ...
    <div class="splash-container">
        <div class="card ">
            ...
            <div class="card-footer bg-white p-0  " style="align-content: center;">
               
                <div class="card-footer-item card-footer-item-bordered" style="text-align: center;" >
                    <a href="forgot-password.jsp" class="footer-link">Forgot Password ?</a>
                </div>
            </div>
        </div>
    </div>
