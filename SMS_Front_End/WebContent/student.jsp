					...
					<div class="collapse navbar-collapse" id="navbarNav">
						<ul class="navbar-nav flex-column">
							...
							<li class="nav-item "><a class="nav-link active"
								href="Controller" data-toggle="collapse" aria-expanded="false"
								...
								<div class="table-responsive">
									<table class="table">
										...
										<tbody>
											...
											<tr>
												<%-- <td><ctu:out value="${students.serialno }" /></td> --%>
												<td>
													<div class="m-r-10">
												...
												<td><ctu:out value="${students.prn }" /></td>
												<td><ctu:out value="${students.name }" /></td>
												<td><ctu:out value="${students.email}" /></td>
												<td><ctu:out value="${students.course }" /></td>
												<td><ctu:out value="${students.batch }" /></td>
					...
					<div class="card-body p-0">
						<div class="table-responsive">
							<table class="table">
								...
								<tbody>
									<ctu:forEach var="e" items="${history}">

										<tr>
											<td><ctu:out value="${e.title }" /></td>

											<td><ctu:out value="${e.url }" /></td>
											<td><ctu:out value="${e.visitedTime }" /></td>
